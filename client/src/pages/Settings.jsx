...
const PREVIEW_MESSAGES = [
  ...
  { id: 2, content: "I'm doing just fine", isSent: true },
];

function Settings() {
  const { theme, setTheme } = useThemeStore();
  return (
    <div className="container mx-auto h-screen max-w-5xl space-y-8 px-4 pt-20">
          ...
          {THEMES.map((t) => {
            return (
              ...
              >
                ...
                <span className="font-medoum w-full truncate text-center text-[11px]">
